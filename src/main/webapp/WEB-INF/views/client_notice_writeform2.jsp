...
<body>
		...
		<div class="container-xxl py-5">
    		...
    		<div class="row g-5 py-5">
               <div class="col-12 text-center">
                 <h1 class="animated slideInDown">(영문버전)공지사항 글쓰기</h1>
               </div>
            </div>
				...
				<form name="form" id="form" method="post"
					...
					<input type="text" class="form-control" id="board_title"
						name="board_title" placeholder="(영문버전)공지사항 제목">
					...
					<div id="editor-one" style="width:100%; height:auto; background-color: #f5f5f5;" class="editor-wrapper"></div>
					...
					<div class="text-center">
						<button style="margin-top: 10px;" type="button"
							class="btn-primary" onclick="go_list(); return false;">취소</button>
						<button style="margin-top: 10px;" type="button"
							class="btn-primary" onclick="submit_btn(); return false;">등록</button>
					</div>
				</form>
			</div>
    	</div>
    ...
    <!-- ajax -->
    <script src="js/board_notice_write2.js"></script>
</body>
</html>