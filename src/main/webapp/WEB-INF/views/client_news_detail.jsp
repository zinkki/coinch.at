...
<body>
 	<div class="container-xxl bg-white p-0">
		...
		<div class="container-xxl py-5 hero-header">
          <div class="container my-5 py-5 px-lg-5">
            ...
            <table class="table">
				...
				<a href="/news" class="btn btn-light py-sm-3 px-sm-5 rounded-pill animated slideInDown"><spring:message code="board.list" text="default text"/></a>
				<a href="/client_news_modifyform?board_seq=${dto.board_seq }" class="btn btn-light py-sm-3 px-sm-5 rounded-pill animated slideInDown" id="admin_space">수정</a>
        ...
        <script src="js/board_news_modify.js"></script>
    </div>
</body>
</html>